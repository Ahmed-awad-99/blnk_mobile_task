...
// Screens
import 'package:blnk_mobile_task/features/user_form/presentation/screens/review_screen.dart';

class IDBackScanScreen extends StatelessWidget {
  const IDBackScanScreen({super.key});
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text(
                  'step 3 (scanning & cropping back id side)',
                  style: TextStyle(
                    fontFamily: 'Georama',
              ...
              Consumer<UserFormProvider>(
                builder: (context, provider, child) {
                  return IDScanWidgets.buildCameraPreview(
                    ...
                    placeholderText: 'Back ID will appear here',
                  );
                },
              ),
                    ...
                    onPressed: () {
                      if (provider.backImage != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('Please scan back ID first'),
                          ),
                        );
                      }
                    },
